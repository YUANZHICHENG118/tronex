...
$(function () {
    ...
    async function getUserRefStats() {
        ...
        let rate=parseFloat((userTotalEarnedTrx+userLeval11)/(userTotalDeposits/1000000)*2)

        if (parseInt(userTotalEarnedTrx) >= 150) {
            $('.totalWin .progress .inner').css("width", parseFloat(rate) + "%").removeClass("y").addClass("r");


        } else if (parseInt(userTotalEarnedTrx) >= 100) {

            $('.totalWin .progress .inner').css("width", parseFloat(rate) + "%").removeClass("normal").addClass("y");

        } else {
            $('.totalWin .progress .inner').css("width", parseFloat(rate) + "%");
