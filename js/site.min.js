...
$(function () {
    ...
    async function getSuperNodeList() {
        ...
        res["addr"].map((item, index) => {
            ...
            if (index <= 9) {
                if (isAddress) {
                    $(".nodelista").append("<p><span class=\"place\">" + (index + 1) + "</span>" + address + "</p>")
                ...
                if (isAddress) {
                    $(".nodelistb").append("<p><span class=\"place\">" + (index + 1) + "</span>" + address + "</p>")
                } else {
                }
            }
        })
