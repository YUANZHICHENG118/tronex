...
$(function () {
    ...
    async function getUserRefStats() {
        ...
        if (parseInt(rate) >= 150) {
            $('.totalWin .progress .inner').css("width", parseInt(rate) + "%").removeClass("y").addClass("r").html(parseInt(rate)+"%");


        } else if (parseInt(rate) >= 100) {

            $('.totalWin .progress .inner').css("width", parseInt(rate) + "%").removeClass("normal").addClass("y").html(parseInt(rate)+"%");

        } else {
            $('.totalWin .progress .inner').css("width", parseInt(rate) + "%").html(parseInt(rate)+"%");
