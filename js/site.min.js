...
$(function () {
    ...
    async function getUserRefStats() {
        ...
        if (parseInt(rate) >= 150) {
            $('.totalWin .progress .inner').css("width", parseInt(rate) + "%").removeClass("y").addClass("r").html(parseFloat(rate) + "%");


        } else if (parseInt(rate) >= 100) {

            $('.totalWin .progress .inner').css("width", parseInt(rate) + "%").removeClass("normal").addClass("y").html(parseFloat(rate) + "%");

        } else {
            $('.totalWin .progress .inner').css("width", parseInt(rate) + "%").html(parseFloat(rate) + "%");
