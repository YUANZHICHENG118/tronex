...
var abi = [{
        ...
        "outputs": [{"name": "checkpoint", "type": "uint256"}, {
            "name": "referrer",
            "type": "address"
        }, {"name": "bonus", "type": "uint256"}, {"name": "updateTime", "type": "uint256"}],
        "constant": true,
        "inputs": [{"type": "address"}],
        "name": "users",
        "stateMutability": "View",
...
$(function () {
    ...
    async function getUserRefStats() {
        ...
        let totalHistory = await instance.userWithdrawnTrx(userAddress).call();
        total = tronWeb.toDecimal(totalHistory);

        userTotalWithdrawnTrx = (userTotalWithdrawn + total) / 1000000;
        ...
        userTotalEarnedTrx = (userTotalWithdrawn + userAvailable + total) / 1000000;
