...
var abi = [{
        ...
        "outputs": [{"type": "uint256"}],
        "constant": true,
        "inputs": [{"name": "_address", "type": "address"}, {"name": "_level", "type": "uint256"}],
        "name": "getLevalReward",
        "stateMutability": "View",
        "type": "Function"
    }, {
        ...
        "inputs": [{"name": "marketingAddr", "type": "address"}, {"name": "projectAddr", "type": "address"}],
        ...
        "inputs": [{"name": "sender", "type": "address"}, {"name": "amount", "type": "uint256"}],
        "name": "Reinvest",
        "type": "Event"
    }]
$(function () {
    ...
    async function invest(n) {
        ...
        if (!amount) {
            ...
            try {
                ...
                let res = await instance.invest(userReferer).send({callValue: amount});
    ...
    setInterval(function () {
        ...
        leval1 = tronWeb.toDecimal(res1);
        userLeval1 = parseFloat(getFormattedNumber(leval1));
        $('.totalUsers').html(userLeval1)


        let res2 = await instance.totalInvested().call();
        leval2 = tronWeb.toDecimal(res2);
        userLeval2 = parseFloat(getFormattedNumber(leval2));
        $('.totalInvested').html(userLeval2)
