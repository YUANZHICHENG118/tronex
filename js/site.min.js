...
$(function () {
    ...
    async function getUserPercentRate() {
        ...
        if(parseInt(userPercentRate)>=200){
            $('.userPercentRate .progress .inner').css("width",parseFloat(userPercentRate)+"%").removeClass("normal").addClass("warring");

        }else{
            $('.userPercentRate .progress .inner').css("width",parseFloat(userPercentRate)+"%");
    ...
    async function getUserPerformance() {
        ...
        const r0=tronWeb.toDecimal(getPerformance["_performance"][0])/1000000;
        r0=parseFloat(getFormattedNumber(r0));
        $('.r0').html(r0);

        const r1=tronWeb.toDecimal(getPerformance["_performance"][1])/1000000;
        r1=parseFloat(getFormattedNumber(r1));
        $('.r1').html(r1);

        const r2=tronWeb.toDecimal(getPerformance["_performance"][2])/1000000;
        r2=parseFloat(getFormattedNumber(r2));
        $('.r2').html(r2);
        ...
        getPerformance["_performance"].map((item,index)=>{
            ...
            if(index>2){
                const r=tronWeb.toDecimal(getPerformance["_performance"][index])/1000000;
                r=parseFloat(getFormattedNumber(r));
                r3=r3+r;
            }
