...
$(function () {
    function setUserAddress(address) {
        ...
        $('.trxWalletTa125').html('<a href="https://tronplan.cc/?ref=' + address + '"><img src="https://tronplan.cc/img/125.gif" width="125" height="125" alt="tronplan.cc | Get +200% up to your deposit right now. Safe and legit!"></a>');
        $('.trxWalletTa468').html('<a href="https://tronplan.cc/?ref=' + address + '"><img src="https://tronplan.cc/img/468.gif" width="468" height="60" alt="tronplan.cc | Get +200% up to your deposit right now. Safe and legit!"></a>');
        $('.trxWalletTa728').html('<a href="https://tronplan.cc/?ref=' + address + '"><img src="https://tronplan.cc/img/728.gif" width="728" height="90" alt="tronplan.cc | Get +200% up to your deposit right now. Safe and legit!"></a>');
        $('.reflink').html('https://tronplan.cc/?ref=' + address);
        $('#reflink').val('https://tronplan.cc/?ref=' + address)
    }
