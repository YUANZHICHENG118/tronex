...
$(function () {
    ...
    async function getUserPercentRate() {
        ...
        if (parseInt(userPercentRate) >= 150) {
            $('.totalWin .progress .inner').css("width", parseFloat(userPercentRate) + "%").removeClass("y").addClass("r");


        }else if (parseInt(userPercentRate) >= 100) {

            $('.totalWin .progress .inner').css("width", parseFloat(userPercentRate) + "%").removeClass("normal").addClass("y");

        } else {
            $('.totalWin .progress .inner').css("width", parseFloat(userPercentRate) + "%");
