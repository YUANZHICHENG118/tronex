...
$(function () {
    function setUserAddress(address) {
        ...
        $('.trxWalletTa125').html('<a href="https://tronex.net/?ref=' + address + '"><img src="https://tronex.net/img/125.gif" width="125" height="125" alt="TRONex.net | Get +200% up to your deposit right now. Safe and legit!"></a>');
        $('.trxWalletTa468').html('<a href="https://tronex.net/?ref=' + address + '"><img src="https://tronex.net/img/468.gif" width="468" height="60" alt="TRONex.net | Get +200% up to your deposit right now. Safe and legit!"></a>');
        $('.trxWalletTa728').html('<a href="https://tronex.net/?ref=' + address + '"><img src="https://tronex.net/img/728.gif" width="728" height="90" alt="TRONex.net | Get +200% up to your deposit right now. Safe and legit!"></a>');
        $('.reflink').html('https://tronex.net/?ref=' + address);
        $('#reflink').val('https://tronex.net/?ref=' + address)
    }
